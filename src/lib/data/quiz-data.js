...
// ==========================================
{
  ...
  options: ['Income mein se sab kuch zero pe lana', 'Har paisa ka kaam decide karna taki Income - All Expenses = 0', 'Savings zero rakhna', 'Har mahine fresh start karna'],
  correctIndex: 1,
  ...
  options: ['Include nahi karna chahiye — unexpected aate hain', 'Kyunki agar plan nahi kiya toh sudden shock aur overspending hoga', 'Sirf agar budget bachta hai toh include karo', 'Festivals budget se alag hain'],
  correctIndex: 1,
...
// ==========================================
{
  ...
  options: ['Apne liye expensive cheez khareedna', 'Income aate hi pehle savings alag karna', 'Salary se pehle advance lena', 'Kharcha karke baad mein bacha hua save karna'],
  correctIndex: 1,
  ...
  options: ['Bahut zyada interest milta hai', 'Market se linked hai toh zyada return', 'Monthly deposit se discipline banti hai aur safe returns milte hain', 'Koi lock-in nahi hai'],
  correctIndex: 2,
...
// ==========================================
{
  ...
  options: ['Stock market mein — zyada growth', 'FD mein — safe but locked', '60% Savings Account + 40% Liquid Mutual Fund', 'Gold mein — safe investment'],
  correctIndex: 2,
  ...
  options: ['Medical emergency hospitalization', 'Job loss aur 3 mahine ka kharcha', 'Flipkart sale mein iPhone sasta mil raha hai', 'Car/bike repair after accident'],
  correctIndex: 2,
...
// ==========================================
{
  ...
  options: ['Credit card se vacation khareedna', 'Education loan for MBA', 'Personal loan for iPhone', 'EMI pe luxury watch'],
  correctIndex: 1,
  ...
  options: ['Sabse chhota debt', 'Sabse zyada interest wala debt', 'Sabse purana debt', 'Sabse bada debt'],
  correctIndex: 1,
...
// ==========================================
{
  ...
  options: ['Stop karo — loss ho raha hai', 'Continue karo — market down mein zyada units milte hain (rupee cost averaging)', 'Double invest karo market down mein', 'SIP cancel karke FD mein daalo'],
  correctIndex: 1,
...
// ==========================================
{
  ...
  options: ['Insurance cover nahi milta', 'High charges (5-10%) aur average returns (6-8%)', 'Tax benefit nahi milta', 'Sirf ameer log le sakte hain'],
  correctIndex: 1,
  ...
  options: ['Company insurance cover kam hota hai', 'Job change ya layoff pe coverage khatam ho jaata hai', 'Corporate insurance slow claim process karta hai', 'Company premium cut karti hai salary se'],
  correctIndex: 1,
  ...
  options: ['Tax benefit nahi milta', 'Dono kaam poorly karte hain — insurance bhi kam, returns bhi kam', 'Government allow nahi karti', 'Zyada paperwork hai'],
  correctIndex: 1,
...
// ==========================================
{
  ...
  options: ['Government ki majburi hai', 'Tax refund claim, loan approval, visa ke liye zaroori', 'Penalty se bachne ke liye', 'Bank account band ho jaata hai bina ITR ke'],
  correctIndex: 1,
...
// ==========================================
{
  ...
  options: ['Celebration party do', 'New phone khareedo', '20% savings mein transfer karo pehle kaam se', 'Sabko treat do'],
  correctIndex: 2,
  ...
  options: ['Naya phone khareed ke profile update karo', 'Expenses immediately cut karo aur emergency fund use karo', 'Personal loan le ke chalao', 'Credit card pe zindagi chalao'],
  correctIndex: 1,
