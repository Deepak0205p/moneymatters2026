...
export function WelcomeOnboarding() {
  ...
  return (
    ...
    >
      {/* Backdrop */}
      <div className="absolute inset-0 bg-midnight/85 backdrop-blur-md premium-dialog-overlay" />
      ...
      >
        ...
        <div className="h-1 w-full bg-gradient-to-r from-transparent via-emerald to-ai" />
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            {step === 0 && (
              ...
              >
                ...
                >
                  <Sparkles className="w-12 h-12 text-emerald-soft mb-4" style={{ filter: 'drop-shadow(0 0 12px rgba(16,185,129,0.4))' }} />
                </motion.div>

                <h1 className="text-4xl sm:text-5xl font-black mb-2">
                  <span className="text-gradient-brand">RUPAIYA 101</span>
                </h1>

                <p className="text-lg text-emerald-soft/80 font-medium mb-6">
                  Hinglish mein seekho, finance ko samjho
                </p>

                <div className="glass-card rounded-xl p-4 mb-6 max-w-sm">
            ...
            {step === 1 && (
              ...
              >
                <motion.div
                  ...
                  style={{ boxShadow: '0 0 20px rgba(16,185,129,0.20)' }}
                >
                  ...
                  {PRIORITY_STRATEGIES.map((strategy, index) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className={`glass-card w-full flex items-center gap-3 p-3 rounded-xl border-2 transition-all text-left ${
                          isSelected
                            ? 'border-emerald bg-emerald/10'
                            : 'border-white/[0.08] hover:bg-white/[0.05] hover:border-white/[0.12]'
                        }`}
                      ...
                      >
                        <div
                          ...
                          style={{ backgroundColor: `${strategy.color}20`, boxShadow: `0 0 12px ${strategy.color}20` }}
                        >
            ...
            {[0, 1, 2].map((s) => (
              <div
                ...
                className={`h-1.5 rounded-full transition-all duration-300 ${
                  s === step ? 'w-8 bg-emerald' : s < step ? 'w-4 bg-emerald/50' : 'w-4 bg-white/[0.1]'
                }`}
              />
            ))}
          </div>
