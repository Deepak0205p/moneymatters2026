...
export function StrategySlide({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'relative w-full perspective-3d',
        className,
      )}
    >
      ...
      <div
        ...
        style={{ background: `radial-gradient(circle at 50% 40%, ${accentColor}, transparent 70%)` }}
      />
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center pt-2">
          ...
          >
            <span style={{ filter: `drop-shadow(0 0 12px ${accentColor}88)` }}>{icon}</span>
          </motion.div>

          {/* "Naya Strategy" eyebrow */}
          <div
          ...
          {/* One-line hook */}
          <p className="text-ink-muted text-sm sm:text-base max-w-md mb-6">{hook}</p>
