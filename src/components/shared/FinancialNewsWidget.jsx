...
import { X, Bookmark, Share2, Sparkles, ChevronUp, Flame, Clock, ExternalLink } from 'lucide-react';
...
export default function FinancialNewsWidget({
  ...
  const forYouCards = useMemo(() => NEWS_DATA.filter(n => FOR_YOU_IDS.includes(n.id)), []);
  ...
  const goToCard = id => setActiveId(id);
  ...
  return /*#__PURE__*/_jsx(Dialog, {
    ...
    children: /*#__PURE__*/_jsxs(DialogContent, {
      className: "max-w-md max-h-[92vh] overflow-hidden p-0 border-white/[0.08] bg-[#0B1220] text-[#F8FAFC] premium-dialog-overlay",
      children: [/*#__PURE__*/_jsx(VisuallyHidden, {
        children: /*#__PURE__*/_jsx(DialogTitle, {
          children: "Financial Insights & News"
        })
      }), /*#__PURE__*/_jsx("div", {
        className: "relative px-5 pt-6 pb-3 bg-gradient-to-b from-emerald-500/10 to-transparent",
          ...
          children: [/*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsx("div", {
              ...
              children: [/*#__PURE__*/_jsx("h2", {
                ...
                children: "Swipe up for next reel \u2B06\uFE0F"
              })]
            })]
          }), /*#__PURE__*/_jsxs("div", {
            className: "px-2.5 py-1.5 rounded-full glass-card text-xs text-[#94A3B8]",
            children: [NEWS_DATA.length, " reels"]
          })]
        })
      }), /*#__PURE__*/_jsxs("div", {
        className: "px-5 pb-3",
        children: [/*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsx(Sparkles, {
            ...
            children: "Tumhare Liye (AI-curated)"
          })]
        }), /*#__PURE__*/_jsx("div", {
          className: "flex gap-2 overflow-x-auto no-scrollbar pb-1",
          children: forYouCards.map(card => {
            const c = CATEGORY_CONFIG[card.category];
            return /*#__PURE__*/_jsxs("button", {
              onClick: () => goToCard(card.id),
              className: cn('min-w-[140px] max-w-[160px] p-3 rounded-2xl glass-card-premium text-left hover:scale-[1.03] transition border', c.border),
              children: [/*#__PURE__*/_jsx("div", {
                className: "text-2xl mb-1.5",
                children: card.emoji
              }), /*#__PURE__*/_jsx("p", {
                className: "text-xs font-semibold text-[#F8FAFC] line-clamp-2 mb-1",
                children: card.headline
              }), /*#__PURE__*/_jsxs("span", {
                className: cn('text-[10px] px-1.5 py-0.5 rounded-full', c.bg, c.color),
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          children: [{
            ...
            id: 'markets',
            ...CATEGORY_CONFIG.markets
          }, {
            id: 'tips',
            ...CATEGORY_CONFIG.tips
          }, {
            id: 'banking',
            ...CATEGORY_CONFIG.banking
          }, {
            id: 'tax',
            ...CATEGORY_CONFIG.tax
          }].map(c => {
        ...
        className: "h-[480px] overflow-y-auto snap-y snap-mandatory no-scrollbar px-5 pb-6 space-y-3",
        children: [filteredNews.map((card, idx) => {
          const c = CATEGORY_CONFIG[card.category];
          ...
          return /*#__PURE__*/_jsxs(motion.div, {
            ...
            children: [/*#__PURE__*/_jsx("div", {
              className: cn('absolute -top-12 -right-12 w-32 h-32 rounded-full blur-3xl opacity-30 bg-gradient-to-br', c.bg.replace('/15', '/40'))
            }), /*#__PURE__*/_jsxs("div", {
              className: "flex items-center justify-between mb-3 relative",
              children: [/*#__PURE__*/_jsxs("span", {
                className: cn('text-[10px] px-2 py-1 rounded-full font-semibold border', c.bg, c.color, c.border),
                children: [c.emoji, " ", c.label]
              }), /*#__PURE__*/_jsxs("span", {
                className: "text-[10px] text-[#94A3B8] flex items-center gap-1",
                children: [/*#__PURE__*/_jsx(Clock, {
                  className: "w-3 h-3"
                }), " ", card.timestamp]
              })]
            }), /*#__PURE__*/_jsx("h3", {
              className: "font-display text-lg font-bold text-[#F8FAFC] leading-snug mb-2 relative",
              children: card.headline
            }), /*#__PURE__*/_jsxs("div", {
              ...
              }), card.cta && /*#__PURE__*/_jsxs("button", {
                onClick: () => goToCard(card.id),
              ...
              children: [/*#__PURE__*/_jsxs("button", {
                ...
                className: cn('flex-1 py-2 rounded-xl text-xs font-semibold transition flex items-center justify-center gap-1.5', bookmarked ? 'bg-amber-400/15 text-amber-300 border border-amber-400/30' : 'glass-card text-[#94A3B8] hover:text-[#F8FAFC]'),
            ...
            }), idx === 0 && /*#__PURE__*/_jsx(motion.div, {
              animate: {
                y: [0, -4, 0],
                opacity: [0.4, 1, 0.4]
              },
        ...
        }), filteredNews.length === 0 && /*#__PURE__*/_jsx("div", {
          className: "grid place-items-center h-40 text-sm text-[#94A3B8]",
          children: "Koi reel nahi mila is category mein \uD83E\uDD37"
        })]
      }), /*#__PURE__*/_jsx(AnimatePresence, {
        children: activeCard && /*#__PURE__*/_jsx(motion.div, {
          initial: {
            opacity: 0
          },
          animate: {
          ...
          children: /*#__PURE__*/_jsxs(motion.div, {
            ...
            className: cn('max-w-sm w-full p-6 rounded-3xl glass-card-premium relative', CATEGORY_CONFIG[activeCard.category].border),
            children: [/*#__PURE__*/_jsx("button", {
              ...
              children: activeCard.emoji
            }), /*#__PURE__*/_jsxs("span", {
              className: cn('text-[10px] px-2 py-1 rounded-full font-semibold', CATEGORY_CONFIG[activeCard.category].bg, CATEGORY_CONFIG[activeCard.category].color),
              children: [CATEGORY_CONFIG[activeCard.category].emoji, " ", CATEGORY_CONFIG[activeCard.category].label]
            }), /*#__PURE__*/_jsx("h3", {
              className: "font-display text-xl font-bold text-[#F8FAFC] leading-snug mt-3 mb-2",
              children: activeCard.headline
            }), /*#__PURE__*/_jsx("p", {
              className: "text-sm text-[#94A3B8] leading-relaxed mb-4",
              children: activeCard.summary
            }), /*#__PURE__*/_jsxs("div", {
              className: "flex items-center gap-3 text-xs text-[#94A3B8] mb-4",
              children: [/*#__PURE__*/_jsxs("span", {
                ...
                children: [/*#__PURE__*/_jsx(Clock, {
                  className: "w-3 h-3"
                }), " ", activeCard.timestamp]
              })]
            }), /*#__PURE__*/_jsxs("div", {
              className: "flex gap-2",
              children: [/*#__PURE__*/_jsxs("button", {
                onClick: () => toggleBookmark(activeCard.id),
                className: cn('flex-1 py-2.5 rounded-xl text-xs font-semibold transition flex items-center justify-center gap-1.5', bookmarks.includes(activeCard.id) ? 'bg-amber-400/15 text-amber-300' : 'glass-card text-[#94A3B8]'),
                children: [/*#__PURE__*/_jsx(Bookmark, {
                  className: cn('w-3.5 h-3.5', bookmarks.includes(activeCard.id) && 'fill-current')
