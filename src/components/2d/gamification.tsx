    ...
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <div className="mb-6 flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gold/15">
                <Coins size={26} className="text-gold-soft" />
              </div>
              <div>
                <h3 className="font-display text-xl font-bold text-ink">Earn Coins</h3>
            ...
            <div className="mt-4 space-y-2">
              {[
                ...
                >
                  ...
                  <span className="text-sm font-bold text-gold-soft tabular-nums">{item.coins}</span>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            <div className="mb-6 flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-ai/15">
                <Award size={26} className="text-ai-soft" />
              </div>
              <div>
                <h3 className="font-display text-xl font-bold text-ink">Mastery Badges</h3>
                <p className="text-sm text-ink-muted">Achievements collect karo</p>
              </div>
            </div>
          ...
          >
            <div className="mb-6 flex items-center gap-4">
              ...
              <div>
                <h3 className="font-display text-xl font-bold text-ink">Daily Streak</h3>
              ...
              {[
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-semibold text-ink">{streak.days} streak</p>
            ...
            <div className="mt-4 rounded-xl bg-gradient-to-r from-emerald/10 to-ai/10 border border-emerald/15 p-3.5">
